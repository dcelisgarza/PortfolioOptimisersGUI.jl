...
makedocs(;
    modules = [PortfolioOptimisersGUI],
    authors = "Daniel Celis Garza <daniel.celis.garza@gmail.com>",
    repo = "https://github.com/dcelisgarza/PortfolioOptimisersGUI.jl/blob/{commit}{path}#{line}",
    sitename = "PortfolioOptimisersGUI.jl",
    format = Documenter.HTML(;
        canonical = "https://dcelisgarza.github.io/PortfolioOptimisersGUI.jl",
    ),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/dcelisgarza/PortfolioOptimisersGUI.jl")
